...
const AboutPage = () => {
  return (
    ...
    <div className="flex min-h-screen flex-col-reverse md:flex-row px-4 md:px-10 items-center justify-center md:justify-between bg-background text-foreground">
      ...
      <div className="right w-10/12 sm:w-8/12 md:w-4/12 flex justify-center mt-8 md:mt-0">
        <Image
          className="rounded-3xl ml-0 md:-ml-10 w-[250px] h-[250px] sm:w-[300px] sm:h-[300px] md:w-[400px] md:h-[400px] object-cover"
          src="/profile.jpeg"
          alt="Profile"
          width={400}
          height={400}
